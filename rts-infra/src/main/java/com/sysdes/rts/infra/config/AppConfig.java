...
public class AppConfig {
    ...
    @Bean
    public HoleService getHoleService(final RobotTrackerRepository robotTrackerRepository){
        return new HoleService(robotTrackerRepository);
    }

    @Bean
    public RobotTrackerService getRobotTrackerService(
            final RobotTrackerRepository robotTrackerRepository, final HoleService holeService){
